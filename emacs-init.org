...
#+end_src
** ВЫПОЛНИТЬ разобраться с авто дополнениями abbrev, dabbrev, hippie expand, Yasnippet,autoinsert
** ВЫПОЛНИТЬ разобраться с проверкою синтаксиса flyspell и т.д.
